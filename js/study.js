...
//To shorten code hover highlighted if statement (option shift and return)<----punch these buttons
//to simplify code (command option L)<----punch these controls
